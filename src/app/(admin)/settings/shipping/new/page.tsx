...
export default function NewShippingRulePage() {
  ...
  if (isLoading || !user) {
    return (
      <AppLayout user={null} title="New Shipping Rule">
  ...
  if (canEdit === false) {
    return (
      <AppLayout user={user} title="Access Denied" description="New Shipping Rule">
        <NoAccess 
          module="Shipping Rules" 
          description="You don't have permission to create shipping rules."
        />
      </AppLayout>
    )
  }
  ...
  return (
    <AppLayout
      ...
      description="Create a new shipping rule"
    >
