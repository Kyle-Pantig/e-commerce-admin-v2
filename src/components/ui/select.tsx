  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Size variants
        size === "xs" && "h-7 px-2 text-xs gap-1 [&_svg:not([class*='size-'])]:size-3",
        size === "sm" && "h-8 px-2.5 text-xs gap-1.5 [&_svg:not([class*='size-'])]:size-3.5",
        size === "default" && "h-9 px-3 text-sm gap-2 [&_svg:not([class*='size-'])]:size-4",
        size === "lg" && "h-10 px-4 text-sm gap-2 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
